...
class PrizeFragment : Fragment() {
    ...
    init {
        ...
        prizes.add(Prize(R.drawable.earphone, "Kulaklık", "25000 P",))
        prizes.add(Prize(R.drawable.my_book, "Sürpriz Kitap", "10000 P",))
        prizes.add(Prize(R.drawable.desk_lamp, "Masa Lambası", "9000 P",))
        prizes.add(Prize(R.drawable.book_set, "Kitap Araç", "8000 P",))
        prizes.add(Prize(R.drawable.book_mark, "Kitap Araç", "4000 P",))
        prizes.add(Prize(R.drawable.ticket_big, "Süpriz Bilet", "4000 P",))
        prizes.add(Prize(R.drawable.ticket_big, "Süpriz Bilet", "3000 P",))
        prizes.add(Prize(R.drawable.ticket_big, "Süpriz Bilet", "2000 P",))
        prizes.add(Prize(R.drawable.ticket_big, "Süpriz Bilet", "1000 P",))
